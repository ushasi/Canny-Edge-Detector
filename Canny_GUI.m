...
% Last Modified by GUIDE v2.5 15-Mar-2018 13:09:30
...
set(handles.text5,'string',val);
global Thresh_Low;
Thresh_Low=val;
handles.Thresh_Low=Thresh_Low;
guidata(hObject, handles);
...
global Thresh_High;
Thresh_High=val;
handles.Thresh_High=Thresh_High;
guidata(hObject, handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[ edge_final ] = Canny_edge(handles.PATHNAME,handles.msize,handles.msigma,handles.Thresh_Low,handles.Thresh_High);
axes(handles.axes3);
imshow(edge_final);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[File_Name, Path_Name] = uigetfile('*.jpg','*.png') %'C:\Users\Swinky\Documents\MATLAB\ASIP\',
       axes(handles.axes1);
       imread([Path_Name,File_Name]);
       imshow([Path_Name,File_Name]);
       set(handles.edit1,'string',[Path_Name,File_Name]);
       global PATHNAME;
       PATHNAME= [Path_Name,File_Name];
